...
public class project10 extends JApplet{
    ...
    public project10() {
        ...
        jmiView.addActionListener(viewListener);
        jmiInsert.addActionListener(insertListener);
        jmiUpdate.addActionListener(updateListener);
        ...
        toolbarView.addActionListener(viewListener);
        toolbarInsert.addActionListener(insertListener);
        toolbarUpdate.addActionListener(updateListener);
        ...
        jbtView.addActionListener(viewListener);

        // Insert Button listener
        jbtInsert.addActionListener(insertListener);

        // Update Button listener
        jbtUpdate.addActionListener(updateListener);
    ...
    public static void main(String[] args) {
        ...
        project10 applet = new project10();
